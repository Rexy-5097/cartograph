...
| [0021](../../docs/adr/ADR-0021-ask-boundary-and-citation-contract.md) | The ASK boundary: surfaces, citation contract, and the first network edge | Proposed · Amendment 1: the frozen specification is available and names no crate for C (AI provider/HTTP client) or D (keychain), so both stay deferred |
